...
/**
 * This is the item provider adapter for a {@link leagueOfLegends.Team} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LeagueOfLegendsPackage.Literals.TEAM__NAME,
				 true,
				 false,
				 false,
	...
	protected void addWinLossRatioPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_Team_winLossRatio_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_Team_winLossRatio_feature", "_UI_Team_type"),
				 LeagueOfLegendsPackage.Literals.TEAM__WIN_LOSS_RATIO,
				 true,
				 false,
				 false,
