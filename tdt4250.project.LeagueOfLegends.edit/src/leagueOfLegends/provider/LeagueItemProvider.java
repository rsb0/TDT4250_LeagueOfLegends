...
/**
 * This is the item provider adapter for a {@link leagueOfLegends.League} object.
 * <!-- begin-user-doc -->
 * <!-- end-user-doc -->
 * @generated
 */
		...
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 ...
				 LeagueOfLegendsPackage.Literals.LEAGUE__NAME,
				 true,
				 false,
				 false,
	...
	protected void addSeasonsPropertyDescriptor(Object object) {
		itemPropertyDescriptors.add
			(createItemPropertyDescriptor
				(((ComposeableAdapterFactory)adapterFactory).getRootAdapterFactory(),
				 getResourceLocator(),
				 getString("_UI_League_seasons_feature"),
				 getString("_UI_PropertyDescriptor_description", "_UI_League_seasons_feature", "_UI_League_type"),
				 LeagueOfLegendsPackage.Literals.LEAGUE__SEASONS,
				 true,
				 false,
				 true,
				 null,
