...
/**
 * <!-- begin-user-doc -->
 * A sample utility for the '<em><b>leagueOfLegends</b></em>' package.
 * <!-- end-user-doc -->
 * @generated
 */
public class LeagueOfLegendsExample {
	/**
	 * <!-- begin-user-doc -->
	...
	public static void main(String[] args) {
		...
		resourceSet.getPackageRegistry().put
			(LeagueOfLegendsPackage.eNS_URI, 
			 LeagueOfLegendsPackage.eINSTANCE);
