 ...
 *   <li>{@link leagueOfLegends.impl.GameStatsImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class GameStatsImpl extends MinimalEObjectImpl.Container implements GameStats {
	...
	public void setName(String newName) {
		...
		name = newName;
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, LeagueOfLegendsPackage.GAME_STATS__NAME, oldName, name));
	}
