...
public class LeagueOfLegendsPackageImpl extends EPackageImpl implements LeagueOfLegendsPackage {
	 ...
	 */
	@Override
	public EAttribute getPlayerStats_Wins() {
	...
	public void createPackageContents() {
		...
		createEAttribute(playerStatsEClass, PLAYER_STATS__WINS);
	...
	public void initializePackageContents() {
		...
		initEAttribute(getPlayerStats_Wins(), ecorePackage.getEInt(), "wins", null, 0, 1, PlayerStats.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
		...
		initEAttribute(getGameStats_Duration(), ecorePackage.getEInt(), "duration", null, 0, 1, GameStats.class, !IS_TRANSIENT, !IS_VOLATILE, IS_CHANGEABLE, !IS_UNSETTABLE, !IS_ID, IS_UNIQUE, !IS_DERIVED, IS_ORDERED);
