...
public class LeagueOfLegendsSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LeagueOfLegendsPackage.LEAGUE_OF_LEGENDS: {
				LeagueOfLegends leagueOfLegends = (LeagueOfLegends)theEObject;
				T result = caseLeagueOfLegends(leagueOfLegends);
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>League Of Legends</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>League Of Legends</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseLeagueOfLegends(LeagueOfLegends object) {
		return null;
	}
