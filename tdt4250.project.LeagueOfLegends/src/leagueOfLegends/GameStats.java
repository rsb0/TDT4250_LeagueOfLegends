 ...
 *   <li>{@link leagueOfLegends.GameStats#getName <em>Name</em>}</li>
 * </ul>
 *
...
public interface GameStats extends EObject {
	 ...
	 * @see #setName(String)
	 * @see leagueOfLegends.LeagueOfLegendsPackage#getGameStats_Name()
	 * @model
	 * @generated
	 */
	String getName();
	...
	/**
	 * Sets the value of the '{@link leagueOfLegends.GameStats#getName <em>Name</em>}' attribute.
	 * <!-- begin-user-doc -->
	 * <!-- end-user-doc -->
